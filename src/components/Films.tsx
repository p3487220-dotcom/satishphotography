...
const YOUTUBE_VIDEOS = [
  {
    id: "lGz-fM02m5g", // Sample high-quality Cinematic Wedding Video ID
    title: "The Royal Wedding Film | Teaser",
    duration: "2:45 Mins",
    category: "Pre Wedding Teaser"
  },
  {
    id: "D4AF37_sample", // Custom placeholder that opens YouTube channel
...
const INSTAGRAM_POSTS = [
  { id: 1, src: "/assets/wedding.webp", likes: "1.2k", comments: "98" },
  { id: 2, src: "/assets/reception.webp", likes: "840", comments: "45" },
  { id: 3, src: "/assets/engagement.webp", likes: "950", comments: "62" },
  { id: 4, src: "/assets/haldi.webp", likes: "1.5k", comments: "120" },
  { id: 5, src: "/assets/half_saree.webp", likes: "720", comments: "31" },
  { id: 6, src: "/assets/outdoor.webp", likes: "1.1k", comments: "88" }
];
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {INSTAGRAM_POSTS.map((post) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative aspect-square overflow-hidden group border border-white/5 glass-panel"
              >
                {/* Thin gold frame border on hover */}
                <div className="absolute inset-0 border border-gold/0 group-hover:border-gold/30 z-20 pointer-events-none transition-all duration-500 m-2" />

                {/* Image */}
                <Image
                  src={post.src}
                  alt="Satish Photography Instagram Post"
                  width={400}
                  height={400}
                ...
                {/* Glass Blur Overlay */}
                <div className="absolute inset-0 bg-[#050505]/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex flex-col justify-center items-center space-y-2">
                  <Instagram className="w-5 h-5 text-gold mb-1" />
                  <div className="flex items-center space-x-4 text-xs font-mono font-light text-white/80">
          ...
          <div className="text-center mt-10">
            ...
            >
              ...
              <span>Follow @satish_photography1</span>
            </a>
          </div>
        </div>
      </div>
